...
~lb(0): integrating validation_checks to login route
~lb(1):
~lb(2):
~lb(3): setting restrictions on routes
...
# and let's put in the logic for logging in a user.
...
lb(2)
# now it's even strange that you see those links when you're logged in;
