...
db.init_app(app)  # refer to line A
...
# Line A: use 'with app.app.context()' to push an aplication context when creating the tables.

# if you don't get any errors, that should have create your database.
# since you're using a SQLite database for now, this database is actually going to be a file in your file system
# and earlier in the app code you set the database URI to be a file in the same directory as your application
# and called that database 'site.db'.

# so, navigate to your project directory and you'll notice that you now have a site.db file in there.
